...
```jsonld
{
  "@context": [
    ...
    "https://avillar.github.io/bblocks-sample-gh-pages/build/annotated/bbr/template/myFeature/context.jsonld",
    {
      "mynamespace": "http://example.org/ns1/"
    }
  ],
...
$defs:
  MyFeature:
    ...
    - properties:
        properties:
          $ref: https://avillar.github.io/bblocks-sample-gh-pages/build/annotated/bbr/template/mySchema/schema.yaml
anyOf:
- $ref: '#/$defs/MyFeature'
...
* YAML version: [schema.yaml](https://avillar.github.io/bblocks-sample-gh-pages/build/annotated/bbr/template/myFeature/schema.json)
* JSON version: [schema.json](https://avillar.github.io/bblocks-sample-gh-pages/build/annotated/bbr/template/myFeature/schema.yaml)
...
[context.jsonld](https://avillar.github.io/bblocks-sample-gh-pages/build/annotated/bbr/template/myFeature/context.jsonld)
...
* URL: [https://github.com/avillar/bblocks-sample-gh-pages](https://github.com/avillar/bblocks-sample-gh-pages)
